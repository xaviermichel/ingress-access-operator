...
import io.neo9.ingress.access.customresources.external.istio.spec.IstioHostsListSpec;
import io.neo9.ingress.access.customresources.external.istio.spec.V1apha3SidecarSpec;
...
public class IstioSidecarReconciler {
	...
	public void reconcile() {
		...
		V1apha3SidecarSpec sidecarSpec = new V1apha3SidecarSpec();
		sidecarSpec.setEgress(List.of(IstioHostsListSpec.builder().hosts(namespaceForSidecar).build()));
